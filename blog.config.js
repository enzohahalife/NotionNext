...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Duality Realm lab', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '在二象之间，发现无限可能', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://drlab.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '二象界实验室,Notion,个人博客，彦晨', // 网站关键词 英文逗号隔开
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://github.com/enzohahalife/picx-images-hosting/raw/master/favicon.8ojrhkrvpt.webp', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '粤ICP备458231267', // 备案号 闽ICP备XXXXXXX
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'codeva-abzWHDkj6j', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'pcs2d3hhx3', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
