...
const BLOG = {
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '[codeva-abzWHDkj6j] -> https://hm.baidu.com/hm.js?[codeva-abzWHDkj6j]', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
